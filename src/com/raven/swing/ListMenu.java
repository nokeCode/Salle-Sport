...
import com.raven.component.EventMenuSelected;
...
public class ListMenu<E extends Object> extends JList<E> {
    ...
    private List<EventMenuSelected> events = new ArrayList<>(); // Liste des écouteurs
    ...
    // Méthode pour déclencher l'événement de sélection
    private void runEvent(int index) {
        for (EventMenuSelected event : events) {
            event.onMenuSelected(index);
        }
    }
